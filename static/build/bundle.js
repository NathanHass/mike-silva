...
/***/ function(module, exports, __webpack_require__) {
	...
	var _mikesilva = __webpack_require__(1);

	var _mikesilva2 = _interopRequireDefault(_mikesilva);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _mikesilva_page_transition = __webpack_require__(2);
	...
	var MikeSilva = {
	    ...
	    */
	    init: function init() {
	        ...
	        try {
	            for (var _iterator = this.modInstances[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	function MikeSilvaHomepage() {
	    this.$topperImage = (0, _jquery2.default)('.hp__img');
	    this.$topperTeases = (0, _jquery2.default)('.js-hp-trigger');
	    this.$featureArea = (0, _jquery2.default)('.hp__img-bg');
	    this.$featureImageArea = (0, _jquery2.default)('.hp__img-bg-img');

	    this.$workImages = (0, _jquery2.default)('.work-tease__img');
	}
	...
	MikeSilvaHomepage.prototype.init = function () {
	    ...
	    if (this.$workImages.length > 0) {
	        this.$workImages.each(function () {
	            ...
	            $this.off().on('load', _mikesilva_utilities2.default.swapImage.bind(this, $this)).each(_mikesilva_utilities2.default.maybeUseCachedImage.bind(this, $this));
	        });
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var MikeSilvaUtilities = {
	    ...
	    */
	    swapImage: function swapImage($image) {
	    ...
	    *   @param  jQuery Obj  $image A jQuery image object
	    */
	    maybeUseCachedImage: function maybeUseCachedImage($image) {
	        if ($image[0].complete) {
	            $image.load();
	        }
	    },
	    ...
	    */
	    isWpUserSignedIn: function isWpUserSignedIn(cb) {
	        var data = { action: 'is_user_logged_in' };

	        _jquery2.default.post("/wp-admin/admin-ajax.php", data, cb);
	    },
...
/***/ function(module, exports, __webpack_require__) {
	...
	function MikeSilvaSingle() {
	    this.$videoMod = (0, _jquery2.default)('.post__video-mod');
	    this.plyrOptions = {};
	    this.player;
	}
	...
	*/
	...
	MikeSilvaSingle.prototype.init = function () {
	    ...
	    if (this.$videoMod.length > 0) {
	        ...
	        if ((0, _jquery2.default)('#js-smoothstate-container').hasClass('is-exiting')) {
	            console.log('test');
	            this._playPlyr();
	        }
	    }
	...
	MikeSilvaSingle.prototype._initPlyr = function () {
	    this.player = new _plyr2.default.setup(document.querySelectorAll('.js-player'), this.options);
	};
